...
Normalizing features and weights onto a unit sphere ($\vert{}\vert{}x\vert{}\vert{}=1, \vert{}\vert{}w\vert{}\vert{}=1$) transforms high-dimensional feature learning into geometric angle optimization.
